...
<!-- registration form starts -->
    <div class="login-container">
      <div class="login-card shadow">
        ...
        <div class="text-center mt-3">
          <small
            >Already have an account?<a href="login.jsp" class="text-warning"
              >Login</a
            ></small
          >
        </div>
    ...
    <%if("true".equals(request.getParameter("showOtp"))){ %>
    	...
    	<div class="modal fade show" id="otpModal" style="display:block;" role="dialog" aria-modal="true">
    	<div class="modal-dialog model-dialog-centered">
    	 <div class="modal-content bg-dark text-white">
    	  <div class="modal-header">
    	    <h5 class="modal-title">Enter OTP to send your email</h5>
